...
if platform.system() == 'Windows':
    ...
    # find local dll if exist, modified by Akiba Arisa
    base_dir = os.path.dirname(__file__)
    lib_path = os.path.join(base_dir, "unrar.dll")
    lib_path = None if not os.path.isfile(lib_path) else lib_path
